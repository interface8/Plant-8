...
//                 ? `/investments/category/${item.name
//                     .toLowerCase()
//                     .replace(" ", "-")}`
//                 : `/investments/${item.category.toLowerCase()}/${item.name
//                     .toLowerCase()
//                     .replace(" ", "-")}`,
...
//                               <Link
//                                 href={category.href || "#"}
//                                 className="block px-3 py-2 text-sm text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-md transition-colors"
//                                 onClick={handleLinkClick}
//                               >
//                                 {category.name}
//                               </Link>
...
//                                         key={subItem.id}
//                                         href={subItem.href || "#"}
//                                         className="block px-4 py-2 text-sm text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-lg transition-colors group"
//                                         onClick={handleLinkClick}
//                                         role="menuitem"
//                                       >
//                                         <span className="group-hover:translate-x-1 transition-transform duration-200 inline-block">
