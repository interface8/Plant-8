...
export default async function ProductDeletePage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 bg-white p-6 rounded shadow">
      ...
      <form action={handleDelete} className="mt-6 flex gap-4">
        ...
        <Button type="button" variant="outline" onClick={() => redirect("/admin/products/all")}>Cancel</Button>
      </form>
    </div>
  );
}
